...
firebase.initializeApp({
    ...
    authDomain: CONFIG.firestore.authDomain,
    storageBucket: CONFIG.firestore.storageBucket,
    messagingSenderId: CONFIG.firestore.messagingSenderId,
    appId: CONFIG.firestore.appId,
    measurementId: CONFIG.firestore.measurementId
  });
